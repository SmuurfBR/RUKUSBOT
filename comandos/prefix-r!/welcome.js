...
exports.run = (client, message, args) => {
    ...
    if (!desenvolvedores.includes(message.author.id) & !message.member.hasPermission('MANAGE_ROLES'))
    ...
    database.Guilds.findOne({
        ...
        if (documento) {
            ...
            if (!razaou.length < 1) {
                ...
                if (message.content.startsWith("r!welcome set")) {
                    if (!razaod.length < 1) {

                        documento.welcomechannel = message.channel.id
                        documento.welcomemsg = message.content.replace("r!welcome set ", "");
                ...
                if (message.content.startsWith("r!welcome remove")) {
                ...
                if (message.content.startsWith("r!welcome info")) {
                    if (!documento.welcome) {
                        message.channel.sendMessage({
                            "embed": {
